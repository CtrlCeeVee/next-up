...
// Sender for mail the site sends (contact form). The domain is verified in
// Resend, so no mailbox has to exist behind this address.
export const CONTACT_FROM = 'Next-Up website <website@next-up.co.za>'
